    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('vehicle_type', models.CharField(choices=[('two', 'Two Wheeler'), ('four', 'Four Wheeler')], max_length=30)),
                ('vehicle_model', models.CharField(choices=[('1_two', 'Standard'), ('2_two', 'Bullet'), ('3_two', 'Sports Bike'), ('4_two', 'Premium Bike'), ('1_four', 'Sedan'), ('2_four', 'H-Back'), ('3_four', 'SUV'), ('4_four', 'Luxury')], max_length=30)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='stores', to='store.VehicleType'),
        ),
        migrations.CreateModel(
            name='Service',
            fields=[
                ...
                ('supported_vehicle_types', models.ManyToManyField(blank=True, to='store.VehicleType')),
            ],
            options={
                'abstract': False,
            },
